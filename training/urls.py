...
urlpatterns = [
    ...
    path('training_update/<int:id>/', views.TrainingUpdateView.as_view(),
    name="training_update"),
    path('training_delete/<int:id>/', views.TrainingDeleteView.as_view(),
    ...
    name="entity_create"),
    path('entity_update/<int:id>/', views.EntityUpdateView.as_view(),
    name="entity_update"),
    path('entity_delete/<int:id>/', views.EntityDeleteView.as_view(),
    name="entity_delete"),
    ...
    path('instructor_update/<int:id>/', views.InstructorUpdateView.as_view(),
    name="instructor_update"),
    path('instructor_delete/<int:id>/', views.InstructorDeleteView.as_view(),
    ...
    name="event_create"),
    path('event_update/<int:id>/', views.EventUpdateView.as_view(),
    name="event_update"),
    path('event_delete/<int:id>/', views.EventDeleteView.as_view(),
    name="event_delete"),
